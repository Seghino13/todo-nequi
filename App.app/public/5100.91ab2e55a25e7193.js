...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    5100: (k, e, g) => {
      g.r(e), g.d(e, { ion_col: () => v, ion_grid: () => f, ion_row: () => b });
      var d = g(4261),
        t = g(9483);
      const m = {
          xs: '(min-width: 0px)',
        ...
        c = (n) =>
          void 0 === n ||
          '' === n ||
          (!!window.matchMedia && window.matchMedia(m[n]).matches),
        o = typeof window < 'u' ? window : void 0,
        s = o && !!(o.CSS && o.CSS.supports && o.CSS.supports('--a: 0')),
        x = ['', 'xs', 'sm', 'md', 'lg', 'xl'],
        v = (() => {
          let n = class {
            constructor(i) {
            ...
            getColumns(i) {
              ...
              for (const r of x) {
                const p = c(r),
                  l = this[i + r.charAt(0).toUpperCase() + r.slice(1)];
                p && void 0 !== l && (a = l);
              }
              return a;
            }
              ...
              const a =
                'auto' === i
                  ...
                  : s
                    ...
                    : (i / 12) * 100 + '%';
              return { flex: `0 0 ${a}`, width: `${a}`, 'max-width': `${a}` };
            }
            calculatePosition(i, a) {
              const r = this.getColumns(i);
              if (!r) return;
              const p = s
                ? `calc(calc(${r} / var(--ion-grid-columns, 12)) * 100%)`
                : r > 0 && r < 12
                  ? (r / 12) * 100 + '%'
                  : 'auto';
              return { [a]: p };
              ...
              return (0, d.h)(
                d.f,
                {
                  ...
                  style: Object.assign(
                    Object.assign(
                      Object.assign(
                        Object.assign({}, this.calculateOffset(i)),
        ...
        b = (() => {
          ...
          return (
            (n.style =
              ':host{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}'),
            n
          );
        })();
    },
