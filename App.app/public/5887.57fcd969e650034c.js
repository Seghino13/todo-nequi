    ...
    5887: (x, a, l) => {
      ...
      const r = 'split-pane-main',
        ...
        p = class {
          constructor(e) {
            (0, n.r)(this, e),
              (this.ionSplitPaneVisible = (0, n.d)(
                this,
                'ionSplitPaneVisible',
                7,
              )),
          ...
          visibleChanged(e) {
            this.ionSplitPaneVisible.emit({ visible: e });
          }
          isVisible() {
            var e = this;
            return (0, d.A)(function* () {
              return Promise.resolve(e.visible);
            })();
          }
          connectedCallback() {
            var e = this;
          ...
          updateState() {
            ...
            const e = this.when;
            if ('boolean' == typeof e) return void (this.visible = e);
            const o = h[e] || e;
            if (0 === o.length) return void (this.visible = !1);
            const t = (s) => {
                this.visible = s.matches;
              },
              i = window.matchMedia(o);
            i.addListener(t),
              (this.rmL = () => i.removeListener(t)),
