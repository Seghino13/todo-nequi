    ...
    3506: (ri, v, l) => {
      ...
      const A = (() => {
          let o = class {
            ...
            labelColorChanged(i) {
              const { color: e } = this;
              void 0 === e && (this.labelColorStyles = i.detail);
            }
            itemStyle(i) {
              i.stopPropagation();
              const e = i.target.tagName,
                r = i.detail,
                g = {},
                c = this.itemStyles.get(e) || {};
              let s = !1;
              Object.keys(r).forEach((m) => {
                ...
                !s &&
                  ...
                  (s = !0),
                s && (this.itemStyles.set(e, g), (0, t.j)(this));
            }
            connectedCallback() {
              this.hasStartEl();
            }
            componentWillLoad() {
              this.inheritedAriaAttributes = (0, u.h)(this.el, ['aria-label']);
            }
            componentDidLoad() {
              (0, u.r)(() => {
            ...
            isFocusable() {
              const i = this.el.querySelector('.ion-focusable');
              return this.canActivate() || null !== i;
            }
            hasStartEl() {
            ...
            render() {
              const {
                ...
                p = this.isClickable(),
                y = this.canActivate(),
                z = p ? (void 0 === m ? 'button' : 'a') : 'div',
                ii =
                  'button' === z
                    ? { type: this.type }
                    : { download: r, href: m, rel: b, target: X };
              let I = {};
              const d = this.getFirstInteractive();
              (p || (void 0 !== d && !w)) &&
                (I = {
                  onClick: (h) => {
                    if ((p && (0, n.o)(m, h, J, Q), void 0 !== d && !w)) {
                      const ni = h.composedPath()[0];
                      h.isTrusted &&
                        this.el.shadowRoot.contains(ni) &&
                        ('ION-INPUT' === d.tagName ||
                        'ION-TEXTAREA' === d.tagName
                          ? d.setFocus()
                          : d.click());
                    }
                  },
                });
              const ti = void 0 !== i ? i : 'ios' === x && p;
              this.itemStyles.forEach((h) => {
                Object.assign(f, h);
              });
              const ei = s || f['item-interactive-disabled'] ? 'true' : null,
                C =
                  (0, n.h)('ion-list', this.el) &&
                  !(0, n.h)('ion-radio-group', this.el),
                oi =
                  void 0 !== d &&
                  !['ION-INPUT', 'ION-TEXTAREA'].includes(d.tagName);
              return (0, t.h)(
                t.f,
                {
                  ...
                  class: Object.assign(
                    ...
                    (0, n.c)(this.color, {
                      item: !0,
                      [x]: !0,
                      'item-lines-default': void 0 === c,
                      [`item-lines-${c}`]: void 0 !== c,
                      'item-control-needs-pointer-cursor': oi,
                      'item-disabled': s,
                      'in-list': C,
        ...
        D = (() => {
          let o = class {
            constructor(i) {
              (0, t.r)(this, i), (this.color = void 0), (this.sticky = !1);
            }
            render() {
              const i = (0, a.b)(this);
              return (0, t.h)(
          ...
          let o = class {
            ...
            render() {
              ...
              return (0, t.h)(t.f, {
                ...
                role: 'group',
                class: { [i]: !0, [`item-group-${i}`]: !0, item: !0 },
              });
            }
          };
          return (
        ...
        R = (() => {
          let o = class {
            constructor(i) {
              (0, t.r)(this, i),
                (this.ionColor = (0, t.d)(this, 'ionColor', 7)),
                (this.ionStyle = (0, t.d)(this, 'ionStyle', 7)),
                (this.inRange = !1),
                (this.color = void 0),
            ...
            emitColor() {
              ...
              this.ionColor.emit({
                ...
                [`ion-color-${i}`]: void 0 !== i,
              });
            }
            emitStyle() {
              const { inRange: i, position: e } = this;
              i ||
                this.ionStyle.emit({ label: !0, [`label-${e}`]: void 0 !== e });
            }
            render() {
              ...
              return (0, t.h)(
                t.f,
                {
                  ...
                  class: (0, n.c)(this.color, {
                    [e]: !0,
                    'in-item-color': (0, n.h)('ion-item.ion-color', this.el),
                    [`label-${i}`]: void 0 !== i,
        ...
        U = (() => {
          let o = class {
            constructor(i) {
              (0, t.r)(this, i), (this.lines = void 0), (this.inset = !1);
            }
            closeSlidingItems() {
              var i = this;
              return (0, S.A)(function* () {
                const e = i.el.querySelector('ion-item-sliding');
                return !(null == e || !e.closeOpened) && e.closeOpened();
              })();
            }
            render() {
              const i = (0, a.b)(this),
                { lines: e, inset: r } = this;
              return (0, t.h)(t.f, {
        ...
        K = (() => {
          let o = class {
            constructor(i) {
              (0, t.r)(this, i), (this.color = void 0), (this.lines = void 0);
            }
            render() {
              const { lines: i } = this,
                e = (0, a.b)(this);
        ...
        Y = (() => {
          let o = class {
            constructor(i) {
              (0, t.r)(this, i), (this.color = void 0);
            }
            render() {
              const i = (0, a.b)(this);
              return (0, t.h)(
        ...
        q = (() => {
          let o = class {
            ...
            render() {
              const i = this.animated && a.c.getBoolean('animated', !0),
                e =
                  (0, n.h)('ion-avatar', this.el) ||
