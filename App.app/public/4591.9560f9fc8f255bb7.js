...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    4591: (Z, v, a) => {
      a.r(v), a.d(v, { ion_button: () => H, ion_icon: () => z });
      var e = a(4261),
        x = a(4920),
        u = a(4929),
        l = a(333),
      ...
      const k = (o, t, n, i, r) => (
          ...
          i && 'ios' === n
            ...
            : r && 'md' === n
              ? (o = c(r))
              : (!o && t && !y(t) && (o = t), d(o) && (o = c(o))),
          d(o) && '' !== o.trim() && '' === o.replace(/[a-z]|-|\d/gi, '')
            ? o
            : null
        ),
        f = (o) => (d(o) && ((o = o.trim()), y(o)) ? o : null),
        y = (o) => o.length > 0 && /(\/|\.)/.test(o),
        d = (o) => 'string' == typeof o,
        c = (o) => o.toLowerCase(),
        $ = (o) =>
          o && '' !== o.dir
            ...
            : 'rtl' ===
              (null == document ? void 0 : document.dir.toLowerCase()),
        H = (() => {
          let o = class {
            constructor(t) {
              (0, e.r)(this, t),
            ...
            renderHiddenButton() {
              ...
              if (t) {
                const { formButtonEl: n } = this;
                if (null !== n && t.contains(n)) return;
                const i = (this.formButtonEl =
            ...
            componentWillLoad() {
              (this.inToolbar = !!this.el.closest('ion-buttons')),
                ...
                (this.inheritedAttributes = (0, x.i)(this.el));
            }
            get hasIconOnly() {
            ...
            submitForm(t) {
              this.formEl &&
                this.formButtonEl &&
                (t.preventDefault(), this.formButtonEl.click());
            }
            render() {
              const t = (0, T.b)(this),
                {
                  ...
                  shape: M,
                  strong: J,
                  inheritedAttributes: Q,
                } = this,
                B = void 0 === I && this.inItem ? 'small' : I,
                O = void 0 === E ? 'button' : 'a',
                Y =
                  'button' === O
                    ? { type: i }
                    : { download: this.download, href: E, rel: b, target: h };
              let g = this.fill;
              return (
                null == g &&
                  (g = this.inToolbar || this.inListHeader ? 'clear' : 'solid'),
                'button' !== i && this.renderHiddenButton(),
                (0, e.h)(
                  e.f,
                  {
                    ...
                    class: (0, l.c)(G, {
                      ...
                      [`${n}-${g}`]: !0,
                      [`${n}-strong`]: J,
                      'in-toolbar': (0, l.h)('ion-toolbar', this.el),
                      'in-toolbar-color': (0, l.h)(
                        'ion-toolbar[color]',
                        this.el,
                      ),
                      'in-buttons': (0, l.h)('ion-buttons', this.el),
                      'button-has-icon-only': N,
                      'button-disabled': r,
                      'ion-activatable': !0,
                      'ion-focusable': !0,
                    }),
                  ...
                  (0, e.h)(
                    ...
                    (0, e.h)(
                      ...
                      (0, e.h)('slot', {
                        key: 'eac497e0f97ab55baa834ae23155d89b0f7069c6',
                      }),
                      (0, e.h)('slot', {
      ...
      const z = class {
          ...
          componentWillLoad() {
            this.inheritedAttributes = ((o, t = []) => {
              ...
              return (
                t.forEach((i) => {
                  o.hasAttribute(i) &&
                    (null !== o.getAttribute(i) && (n[i] = o.getAttribute(i)),
                    o.removeAttribute(i));
                }),
                n
              );
          ...
          loadIcon() {
            if (this.isVisible) {
              const o = ((o) => {
                ...
                return (
                  t ||
                  ((t = k(o.name, o.icon, o.mode, o.ios, o.md)),
                  t
                    ? ((o, t) => {
                        const n = (() => {
                          ...
                          if (!p) {
                            ...
                            (o.Ionicons = o.Ionicons || {}),
                              (p = o.Ionicons.map =
                                o.Ionicons.map || new Map());
                          }
                          return p;
                        })().get(o);
                        if (n) return n;
                        try {
                          return (0, e.k)(`svg/${o}.svg`);
                        } catch {
                          console.warn(
                            `[Ionicons Warning]: Could not load icon with name "${o}". Ensure that the icon is registered using addIcons or that the icon SVG data is passed directly to the icon component.`,
                            t,
                          );
                        }
                      })(t, o)
                    : o.icon &&
                        ((t = f(o.icon)), t || ((t = f(o.icon[o.mode])), t))
                      ? t
                      : null)
                );
              })(this);
              o &&
                (s.has(o)
                  ? (this.svgContent = s.get(o))
                  : ((o, t) => {
                      let n = C.get(o);
                      if (!n) {
                        if (!(typeof fetch < 'u' && typeof document < 'u'))
                          return s.set(o, ''), Promise.resolve();
                        if (
                          ...
                          const r = m
                            ...
                            .querySelector('svg');
                          return r && s.set(o, r.outerHTML), Promise.resolve();
                        }
                        (n = fetch(o).then((i) => {
                          if (i.ok)
                            return i.text().then((r) => {
                              r &&
                                ...
                                (r = ((o) => {
                                  ...
                                  t.innerHTML = o;
                                  for (
                                    let i = t.childNodes.length - 1;
                                    i >= 0;
                                    i--
                                  )
                                    'svg' !==
                                      t.childNodes[i].nodeName.toLowerCase() &&
              ...
              Object.assign(
                {
                  role: 'img',
                  class: Object.assign(
                    Object.assign({ [r]: !0 }, K(this.color)),
                    {
        ...
        R = () =>
          ...
          'md',
        K = (o) => (o ? { 'ion-color': !0, [`ion-color-${o}`]: !0 } : null);
      z.style =
