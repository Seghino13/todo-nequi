    ...
    4463: (D, b, i) => {
      ...
      const x = (() => {
          let r = class {
            ...
            activatedChanged() {
              const t = this.activated,
                a = this.getFab();
              a && (a.activated = t),
                Array.from(this.el.querySelectorAll('ion-fab-list')).forEach(
                  (e) => {
                    e.activated = t;
                  },
                );
            ...
            toggle() {
              var t = this;
              return (0, d.A)(function* () {
                t.el.querySelector('ion-fab-list') &&
                  (t.activated = !t.activated);
              })();
            }
            render() {
              const { horizontal: t, vertical: a, edge: e } = this,
                n = (0, s.b)(this);
              return (0, o.h)(
                o.f,
                {
            ...
            render() {
              ...
              return (0, o.h)(
                o.f,
                {
                  ...
                  class: (0, c.c)(e, {
                    [u]: !0,
                    'fab-button-in-list': p,
                    'fab-button-translucent-in-list': p && f,
                    'fab-button-close-active': l,
                    'fab-button-show': E,
                    'fab-button-disabled': a,
                    'fab-button-translucent': f,
                    'ion-activatable': !0,
                    'ion-focusable': !0,
                    [`fab-button-${h}`]: void 0 !== h,
                  }),
                },
                (0, o.h)(
                  g,
        ...
        C = (() => {
          let r = class {
            constructor(t) {
              (0, o.r)(this, t), (this.activated = !1), (this.side = 'bottom');
            }
            activatedChanged(t) {
              const a = Array.from(this.el.querySelectorAll('ion-fab-button')),
                e = t ? 30 : 0;
              a.forEach((n, l) => {
                setTimeout(() => (n.show = t), l * e);
              });
            }
            render() {
              const t = (0, s.b)(this);
