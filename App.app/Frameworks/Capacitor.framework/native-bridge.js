...
var nativeBridge = (function (exports) {
  ...
  const createProxyUrl = (url, win) => {
    ...
    const bridgeUrl = new URL(
      (_b =
        (_a = win.Capacitor) === null || _a === void 0
          ? void 0
          : _a.getServerUrl()) !== null && _b !== void 0
        ? _b
        : '',
    );
  ...
  const initBridge = (w) => {
    const getPlatformId = (win) => {
      ...
      if (win === null || win === void 0 ? void 0 : win.androidBridge) {
        ...
        (_b =
          (_a = win === null || win === void 0 ? void 0 : win.webkit) ===
            null || _a === void 0
            ? void 0
    ...
    const initEvents = (win, cap) => {
      cap.addListener = (pluginName, eventName, callback) => {
        ...
        return {
          remove: async () => {
            var _a;
            (_a = win === null || win === void 0 ? void 0 : win.console) ===
              null || _a === void 0
              ? void 0
        ...
        if (ev) {
          if (target === 'document') {
            if (
              ...
              doc === null || doc === void 0 ? void 0 : doc.dispatchEvent
            ) {
            ...
            doc === null || doc === void 0 ? void 0 : doc.querySelector
          ) {
    ...
    const initLegacyHandlers = (win, cap) => {
      ...
      if (nav) {
        ...
        nav.app.exitApp = () => {
          var _a;
          if (
            !((_a = cap.Plugins) === null || _a === void 0 ? void 0 : _a.App)
          ) {
    ...
    const initVendor = (win, cap) => {
      ...
      IonicWebView.getServerBasePath = (callback) => {
        var _a;
        (_a =
          Plugins === null || Plugins === void 0 ? void 0 : Plugins.WebView) ===
          null || _a === void 0
          ? void 0
      ...
      if (platform == 'android' || platform == 'ios') {
        ...
        if (doPatchHttp) {
          ...
          window.fetch = async (resource, options) => {
            ...
            try {
              const { body } = request;
              const optionHeaders = Object.fromEntries(
                    ...
                    .then((nativeResponse) => {
                      ...
                      if (this.readyState == 2) {
                        ...
                        this.responseText = (
                          (_a =
                            nativeResponse.headers['Content-Type'] ||
                            nativeResponse.headers['content-type']) === null ||
                          _a === void 0
                            ? void 0
    ...
    function initNativeBridge(win) {
      ...
      const webviewServerUrl =
        typeof win.WEBVIEW_SERVER_URL === 'string'
      ...
      cap.toNative = (pluginName, methodName, options, storedCallback) => {
        ...
        try {
          ...
          (_b = win === null || win === void 0 ? void 0 : win.console) ===
            null || _b === void 0
            ? void 0
            : _b.error(e);
        }
